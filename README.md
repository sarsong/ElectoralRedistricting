...
Once you have the configuration JSON file, you run run.py to execute the entire simulation workflow sequentially. You only need to specify the path to the config file.
...
Post-processes the election results into a dataframe and generates histograms of seat counts for comparative analysis.
